...
func (a Seller) Get(context echo.Context, c container.Container) error {
	return context.JSON(http.StatusOK, response.NewSellerResponse(&entity.Seller{}))
}
...
func (a Seller) Create(context echo.Context, c container.Container) error {
	...
	return context.JSON(http.StatusOK, response.NewSellerResponse(result))
}
...
func (a Seller) List(context echo.Context, c container.Container) error {
	...
	return context.JSON(http.StatusOK, response.NewSellerListResponse(sellers))
}
